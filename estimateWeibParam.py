...
# data
xdata=[1.1,2.2,3.0,4.2,4.8,5.1,5.2,5.3,6,7.1,8.1,7.2,7.3,8.9,8.8,\
9.3,9.4,10.1,10.2,10.8,11.2,11.5,12.6,12.1,13.1,13.3,13.4,15,16,17,20,22,22]
xdata.sort()
...
plt.hist(xdata,bins=b,normed=True)
